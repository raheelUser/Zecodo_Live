...
class PaypalController extends Controller
{
    ...
    public function authorized(){
        ...
        curl_setopt($ch, CURLOPT_USERPWD, 'AfOBh6y7NrpKCXOjUDY8g2AvG65vQm9ncEpUTrcDQLWMbc7BlQV0Q8EpIYVe_2B-ymThQyzkyVzhVh-b' . ':' . 'EJdGmI7DN_K6dmiWcQKsBFem863l-VGtg07-KZ9WCoTpKFESweWqA1Vu2kH7Ewqj9NV_OhvGiNRNebxN');
    ...
    public function payments(){
            ...
            curl_setopt($ch, CURLOPT_URL, 'https://api-m.sandbox.paypal.com/v1/shipping/trackers');
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
            curl_setopt($ch, CURLOPT_POST, 1);
            curl_setopt($ch, CURLOPT_POSTFIELDS, "{\n  \"trackers\": [\n    {\n      \"transaction_id\": \"8MC585209K746392H\",\n      \"tracking_number\": \"443844607820\",\n      \"status\": \"SHIPPED\",\n      \"carrier\": \"FEDEX\",\n      \"shipment_direction\": \"FORWARD\"\n    },\n    {\n      \"transaction_id\": \"53Y56775AE587553X\",\n      \"tracking_number\": \"443844607821\",\n      \"status\": \"SHIPPED\",\n      \"carrier\": \"FEDEX\"\n    }\n  ]\n}");

            $headers = array();
            $headers[] = 'X-Paypal-Security-Context: A21AAKB3KM7upDO_uX83qSm5sI56anb6Uq6ToUJG1p8we9e6xcjG_FhtY6iCRGdhmMk0UGw6UA7fZ_5J-HB71DF0o3wxEgktw';
