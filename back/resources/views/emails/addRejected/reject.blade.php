@component('mail::message')
    <div style="background-color: #f9d9eb; padding:20px;">
        ...
        <p>Our team carefully reviewed your listing and found that it did not meet our standards for quality and accuracy. Some common reasons for ad rejection include inaccurate or incomplete product descriptions, low-quality images, or listing items that are not allowed on our platform.</p>
