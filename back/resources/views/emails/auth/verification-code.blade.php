@component('mail::message')
    <div style="background-color: #f9d9eb; padding:20px;">
        <p>Dear {{$user->name}}</p>
        <p>Welcome to Zecodo following is your Verification Code:</p>
        ...
        <p>If you did not make this request, please ignore this email and ensure that your account is secure</a>.</p>
