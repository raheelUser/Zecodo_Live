...
import Refundcheck from '../../../Images/userimages/backpaymentimages/check.png'
...
const Backpayment = () => {
  ...
  <div className='paymentpending'>
       ...
       <div className='shipping-details'>
        ...
        <a href="#" className='modal-links'><button style={{backgroundColor: "#F9D100"}}>Claim Refund</button></a>
       </div>
            </div>
            <div className='col-4'>
...
{/* MODAL REFUND */}
<div id="refundmodals" class="custom-modal">
        <div class="custom-modal-dialog">
            <div class="custom-modal-content">
               <span class="close-modal">X</span>
                <div class="custom-modal-body">
                    <div class="custom-modal-inner">
                        <div className='refund-modal-check'>
                            <img src={Refundcheck} />
                            <h2>Refund Claim Successful</h2>
                            <p>Your refund amount $2.00 will be added in<br /> your wallet within 24 Hrs </p>
                        </div>
                    </div>
                </div>
            </div>
